...
{
    protected $logger;
    protected $balanceOperationFactory;
    protected $id;


    public function __construct(LoggerInterface $logger, BalanceOperationFactory $balanceOperationFactory)
    {
        $this->logger = $logger;
    ...
    public function execute(AMQPMessage $message)
    {
        ...
        try {
            ...
            $operation = $this->balanceOperationFactory->create($payload['operation']);
